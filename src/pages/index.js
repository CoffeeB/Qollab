    ...
    <>
      ...
      <section className='container-fluid py-5'>
        <div className='d-flex flex-column align-items-center px-10'>
          ...
          <div className="row row-cols-1 row-cols-md-3 g-4 m-0 flex-nowrap px-4" style={{ msOverflowStyle: 'none', scrollbarWidth: 'none', animation: 'marqueeLeft 50s linear infinite'}}>
          ...
          <div className="row row-cols-1 row-cols-md-3 g-4 m-0 flex-nowrap px-4" style={{ msOverflowStyle: 'none', scrollbarWidth: 'none', animation: 'marqueeRight 50s linear infinite'}}>
            <div className="col-5 p-2 m-0 mt-1">
              <div className="card w-100 border-secondary border-2">
                <div className='card-title p-3 row m-0 align-items-center'>
                  <Image
