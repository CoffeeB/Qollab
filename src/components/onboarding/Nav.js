...
export default function Nav() {
  return (
    <>
      <nav className="navbar navbar-light bg-dark fixed-top navbar-expand-lg py-4 w-100">
        <div className="container px-3 my-2">
          ...
          <div className="offcanvas offcanvas-start offcanvas-nav bg-dark" id="offcanvasNav" style={{ width: "20rem" }}>
